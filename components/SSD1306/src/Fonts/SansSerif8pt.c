...
const uint8_t SansSerif8ptBitmaps[] =
{
  // @0 ' ' (5 pixels wide)
  0x00, //
  0x00, //
...
const FontCharDesc_t SansSerif8ptDescriptors[] =
{
  {5, 0},     // ' '
  {1, 12},    // !
  {4, 24},    // "
...
const FontInfo_t SansSerif8ptFontInfo =
{
  12,                       // Character height
  1,                        // C
  ' ',                      // Start character
  '~',                      // End character
  SansSerif8ptDescriptors,  // Character descriptor array
  SansSerif8ptBitmaps,      // Character bitmap array
};
